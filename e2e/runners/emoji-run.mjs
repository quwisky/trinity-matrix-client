// Orchestrator for `pnpm e2e:emoji`: stand up the disposable Synapse + Caddy
// harness, run the composer emoji e2e (`:shortcode` autocomplete, inline
// conversion, and the ngx-emoji-mart picker), then tear everything down — even
...
// www/ build. Never run them concurrently. emoji.mjs serves on its own port
// (8132) to allow a decoupled-build future.
