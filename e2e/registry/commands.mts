...
export const E2E_PACKAGE_SCRIPTS = [
  ...
  {
    name: 'e2e:android:composer-drafts',
    command: 'nx run trinity-e2e-android:composer-drafts',
    kind: 'canonical',
    suiteIds: ['android.composer-drafts'],
  },
  {
    name: 'e2e:android:composer-formatting',
    command: 'nx run trinity-e2e-android:composer-formatting',
    kind: 'canonical',
  ...
  {
    name: 'e2e:android:composer-typing',
    command: 'nx run trinity-e2e-android:composer-typing',
    kind: 'canonical',
  ...
  {
    name: 'e2e:android:jump-to-latest',
    command: 'nx run trinity-e2e-android:jump-to-latest',
    kind: 'canonical',
  ...
  {
    name: 'e2e:android:message-forward',
    command: 'nx run trinity-e2e-android:message-forward',
    kind: 'canonical',
    suiteIds: ['android.message-forward'],
  },
  {
    name: 'e2e:android:message-grouping',
    command: 'nx run trinity-e2e-android:message-grouping',
    kind: 'canonical',
...
export const E2E_CI_ENTRYPOINTS = [
  ...
  {
    command:
      'if [ "${{ matrix.shard }}" = "2" ]; then echo \'composer-drafts-started=true\' >> "$GITHUB_OUTPUT"; TRINITY_ANDROID_SERIAL="$ANDROID_SERIAL" pnpm exec nx run trinity-e2e-android:composer-drafts; fi',
    tier: 'pull-request',
    suiteIds: ['android.composer-drafts'],
  },
  {
  ...
  {
    command:
      'if [ "${{ matrix.shard }}" = "2" ]; then echo \'message-forward-started=true\' >> "$GITHUB_OUTPUT"; TRINITY_ANDROID_SERIAL="$ANDROID_SERIAL" pnpm nx run trinity-e2e-android:message-forward; fi',
    tier: 'pull-request',
    suiteIds: ['android.message-forward'],
  },
  {
    command:
      'if [ "${{ matrix.shard }}" = "2" ]; then echo \'message-grouping-started=true\' >> "$GITHUB_OUTPUT"; TRINITY_ANDROID_SERIAL="$ANDROID_SERIAL" pnpm nx run trinity-e2e-android:message-grouping; fi',
    tier: 'pull-request',
    suiteIds: ['android.message-grouping'],
  },
  {
  ...
  {
    command:
      'if [ "${{ matrix.shard }}" = "1" ]; then echo \'message-poll-started=true\' >> "$GITHUB_OUTPUT"; TRINITY_ANDROID_SERIAL="$ANDROID_SERIAL" pnpm exec nx run trinity-e2e-android:message-poll; fi',
    tier: 'pull-request',
    suiteIds: ['android.message-poll'],
  },
  {
