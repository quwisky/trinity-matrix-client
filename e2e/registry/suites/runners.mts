...
export const RUNNER_E2E_SUITES = defineSuites([
  ...
  },
  {
    ...
    sourceEntrypoints: [
      ...
      'e2e/android/message-quote-artifacts.mts',
    ],
  },
  {
    id: 'android.message-receipts',
    environment: 'android',
    capabilities: ['conversations'],
    contractTypes: ['host', 'journey'],
    runner: 'node-test',
    ...
    targetArtifactRoot: artifactRoot('trinity-e2e-android'),
    sourceEntrypoints: [
      'e2e/android/message-receipts-journeys.mts',
      'e2e/android/message-receipts-contract.mts',
      'e2e/android/message-receipts-observer.mts',
      'e2e/android/message-receipts-artifacts.mts',
    ],
  },
  {
    id: 'android.message-source',
    environment: 'android',
    capabilities: ['conversations'],
    contractTypes: ['host', 'journey'],
    runner: 'node-test',
    ...
    targetArtifactRoot: artifactRoot('trinity-e2e-android'),
    sourceEntrypoints: [
      'e2e/android/message-source-journeys.mts',
      'e2e/android/message-source-contract.mts',
      'e2e/android/message-source-observer.mts',
      'e2e/android/message-source-artifacts.mts',
    ],
  },
  {
    id: 'android.message-spoiler',
    environment: 'android',
    capabilities: ['conversations'],
    contractTypes: ['host', 'journey'],
    runner: 'node-test',
    ...
    targetArtifactRoot: artifactRoot('trinity-e2e-android'),
    sourceEntrypoints: [
      'e2e/android/message-spoiler-journeys.mts',
      'e2e/android/message-spoiler-contract.mts',
      'e2e/android/message-spoiler-fixture.mts',
      'e2e/android/message-spoiler-observer.mts',
      'e2e/android/message-spoiler-artifacts.mts',
    ],
  },
] as const);
