...
function assertNativeRuntime(sources) {
  ...
  requireFragments(sources.client, [
    ...
    'hits.every(candidate=>candidate===hit)',
    'nativeLongPressPaddingHitMatches.toString()',
    "hit.classList.contains('msg__padding-touch')",
    "userSelect === 'none'",
    'nativeLongPressPaddingSurfaceFits.toString()',
    'surface.right - surface.left - 12',
...
describe('Android message-action-sheet migration', () => {
  ...
  it('detects realistic ownership, geometry, semantic and cleanup mutations', () => {
    ...
    const mutations = [
      ...
      ['client', 'hits.every(candidate=>candidate===hit)', 'true'],
      [
        'client',
        'nativeLongPressPaddingHitMatches.toString()',
        '(()=>true).toString()',
