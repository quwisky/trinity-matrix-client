...
@Directive({
	...
	// `BrnTabsList` publishes neither an input nor an output; `variant` below is this
	// directive's own. Stated empty rather than shorthand, per the kit's rule.
	hostDirectives: [{ directive: BrnTabsList, inputs: [], outputs: [] }],
	host: {
		'data-slot': 'tabs-list',
