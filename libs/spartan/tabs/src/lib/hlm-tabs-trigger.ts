...
@Directive({
	...
	// active is reported by `BrnTabs.tabActivated`, exposed on `HlmTabs`, not per trigger.
	hostDirectives: [{ directive: BrnTabsTrigger, inputs: ['brnTabsTrigger: hlmTabsTrigger', 'disabled'], outputs: [] }],
	host: {
