...
import type { ApplicationStartupStage } from './application-runtime.models';
...
} as const satisfies Record<string, ApplicationStartupProducerPolicy>;
...
const PREFERENCE_MIGRATION_ALLOWANCE_MS = 30_000;
...
export const APPLICATION_STARTUP_WATCHDOG_BUDGET_MS =
  ...
  PREFERENCE_MIGRATION_ALLOWANCE_MS +
