 ...
 *
 * A thin, stateless delegate. The dialog service provides the same wrapper to the component and
 * opener so either owner can use its vendor-neutral `isTopmost()` query.
 */
