...
const colorRoles = Object.freeze([
  ...
  '--trinity-accent-tint-20',
  '--trinity-accent-tint-30',
  '--trinity-link',
  '--trinity-success',
  '--trinity-success-solid',
  '--trinity-success-solid-foreground',
  '--trinity-success-tint-20',
  '--trinity-warning',
  '--trinity-warning-solid',
  '--trinity-warning-solid-foreground',
  '--trinity-warning-tint-10',
  '--trinity-danger',
