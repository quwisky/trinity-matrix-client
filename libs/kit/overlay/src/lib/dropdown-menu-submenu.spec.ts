...
// Imported straight from the owning helm lib (libs/kit/dropdown-menu). Like the
...
// Regression guard for the zoneless submenu fix in TrnDropdownMenuSubTrigger.
//
...
@Component({
  ...
  template: `
    <button [trnDropdownMenuTrigger]="menu" data-testid="root-trigger">
      Open
    </button>
    <ng-template #menu>
      <div trnDropdownMenu>
    ...
    <ng-template #sub>
      <div trnDropdownMenuSub>
        <button trnDropdownMenuItem data-testid="sub-item">Deep item</button>
      </div>
    </ng-template>
  `,
})
...
describe('TrnDropdownMenuSubTrigger — submenu open semantics', () => {
...
@Component({
  ...
  imports: [TrnDropdownMenuTrigger, TrnDropdownMenu, TrnDropdownMenuSubTrigger],
  template: `
    <button [trnDropdownMenuSubTrigger]="empty" data-testid="sub"></button>
    <button
      [trnDropdownMenuSubTrigger]="empty"
      side="bottom"
      data-testid="sub-forced"
    ></button>
    <button [trnDropdownMenuTrigger]="empty" data-testid="root"></button>
    <ng-template #empty><div trnDropdownMenu></div></ng-template>
  `,
})
class TriggerHost {}
...
describe('TrnDropdownMenuSubTrigger — submenu placement', () => {
...
@Component({
  ...
  imports: [TrnDropdownMenu],
  template: `<div trnDropdownMenu data-testid="menu"></div>`,
})
class AimHost {}
...
describe('TrnDropdownMenu — menu aim', () => {
...
@Component({
  ...
  imports: [TrnDropdownMenuTrigger, TrnDropdownMenu, TrnDropdownMenuItem],
  template: `
    <button [trnDropdownMenuTrigger]="menu" data-testid="root-trigger">
      Open
    </button>
    <ng-template #menu>
      <div trnDropdownMenu>
        <button trnDropdownMenuItem variant="destructive" data-testid="danger">
          Leave room
        </button>
      </div>
    </ng-template>
...
describe('TrnDropdownMenuItem — destructive colouring', () => {
