...
//
// `<trn-toaster/>` wraps `@spartan-ng/brain/sonner`'s `<brn-sonner-toaster/>`, which
...
describe('TrnToastService → <trn-toaster/> (shared brain sonner state)', () => {
