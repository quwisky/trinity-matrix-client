 ...
 *
 * `@trinity/kit/overlay` is the only door feature code has to dialogs — since #151 no
 * file outside `libs/kit/` imports `@angular/cdk` at all, and #148 turns that into a
 ...
 */
describe('@trinity/kit/overlay vendor surface', () => {
