...
| ----------------------- | ----- | ----------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `ModalController`       | 70    | `brain/dialog` (CDK) + `hlm-dialog` | `TrnDialogService.open()/openAndWait()` ✅ built · sweeping call sites: user-picker ✅, quick-switcher ✅, message-search ✅ + thread-view / threads-list ✅ (`side:'end'` panels); encryption-dialog (libs/ui) ▢ |
