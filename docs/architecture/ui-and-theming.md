...
| Scrollbars          | `--trinity-scrollbar-size`, `-radius`, `-thumb` and `-track` define one visible vertical and horizontal scrollbar treatment. Blink/WebKit use the fixed 8px rounded geometry; Firefox shares the theme-aware colour and its platform-defined `thin` geometry.                                                                                                                                                                                                                                                                                                                                                                                        |
