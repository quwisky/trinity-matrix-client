...
| Radii                               | Control/container roles: `--trinity-radius` (8px), `-sm` (4px), `-md` (6px), `-xl` (12px), `-pill` (9999px). Semantic identity roles: `--trinity-shape-person-radius` (circle) and `--trinity-shape-place-radius` (squircle).                                                                                                                                                                                                                                                                                                                                                    |
