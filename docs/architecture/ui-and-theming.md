...
| Scrollbars          | `--trinity-scrollbar-size`, `-radius`, `-thumb` and `-track` define one visible vertical and horizontal scrollbar design. The thumb follows the active mode and palette through `--trinity-text-muted`; Compact density re-cuts its size with the spacing scale.                                                                                                                                                                                                                                                                                                                                                                                     |
