...
| Spacing and density | `--trinity-space-1`…`-7` — a 4px rhythm (2, 4, 8, 12, 16, 24, 32). Components consume `--trinity-density-item-gap`, `-row-gap`, `-row-padding-*` and `-control-size`; Compact re-cuts these while `--trinity-interaction-target-min-size` enforces the global 44px coarse-pointer floor.                                                                                                                                                                                                                                                                                         |
...
The default focus role deliberately resolves to the measured link colour rather than the accent
...
Both focus recipes are checked against their semantic surfaces in every palette/mode combination.
