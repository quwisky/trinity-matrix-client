...
!!! warning "Components never import matrix-js-sdk"
    ...
    `libs/ui/**`, `libs/kit/**`, `libs/platform-native/**`, `libs/testing/**` and
    `apps/**`. Read that array rather than trusting this list. `libs/kit` is included
    even though it is generated: leaving it out made this rule the one thing `libs/ui` and
    `libs/kit` disagreed on, which `scripts/lint-invariants.spec.mjs` correctly failed.
