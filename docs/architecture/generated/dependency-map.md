...
This snapshot contains **67 Nx projects** and **237 dependencies**. No project cycles detected.
...
| `scripts`                         | `scripts`                              | unmanaged tooling/test                          |                   2 |
...
| `trinity-e2e-components`          | `e2e/components`                       | unmanaged tooling/test                          |                   5 |
| `trinity-e2e-support`             | `e2e/support`                          | unmanaged tooling/test                          |                   0 |
| `trinity-e2e-web`                 | `e2e/web`                              | unmanaged tooling/test                          |                   4 |
