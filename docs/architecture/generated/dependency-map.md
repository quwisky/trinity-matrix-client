...
This snapshot contains **82 Nx projects** and **272 dependencies**. No project cycles detected.
...
| `feature-rooms`             | `data-access-auth`          | #302, #310    | The room shell currently coordinates account switching and navigation.   |
...
| `data-access-accounts`         | `libs/data-access/accounts`         | role:capability; capability:accounts                                                                                     |                   2 |
...
| `feature-rooms`                | `libs/feature/rooms`                | role:capability; capability:conversations, capability:room-library, capability:room-administration, capability:discovery |                  41 |
