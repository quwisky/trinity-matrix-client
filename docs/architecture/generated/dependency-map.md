...
This snapshot contains **83 Nx projects** and **282 dependencies**. No project cycles detected.
...
| `feature-shell`                | `libs/feature/shell`                | role:application; capability:workspace, capability:runtime, capability:badge                                                                    |                  11 |
...
| `platform-native`              | `libs/platform-native`              | role:adapter; capability:host                                                                                                                   |                   3 |
