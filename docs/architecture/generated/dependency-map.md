...
This snapshot contains **73 Nx projects** and **265 dependencies**. No project cycles detected.
...
| `components-controls`             | `libs/components/controls`             | role:design-system; capability:design-system    |                  10 |
