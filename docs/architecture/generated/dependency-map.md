...
This snapshot contains **73 Nx projects** and **266 dependencies**. No project cycles detected.
...
| --------------------------------- | -------------------------------------- | ----------------------------------------------- | ------------------: |
| `application-appearance`          | `libs/application/appearance`          | role:application; capability:design-system      |                   3 |
