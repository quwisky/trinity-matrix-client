...
This snapshot contains **73 Nx projects** and **273 dependencies**. No project cycles detected.
...
| `data-access-room-library`        | `libs/data-access/room-library`        | role:capability; capability:room-library        |                   4 |
