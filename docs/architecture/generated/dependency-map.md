...
This snapshot contains **81 Nx projects** and **271 dependencies**. No project cycles detected.
...
| `data-access-matrix-client`    | `libs/data-access/matrix-client`    | role:adapter; capability:matrix-runtime                                                                                  |                   2 |
