...
| `role:application`   |        4 | `role:application`, `role:capability`, `role:kernel`, `role:adapter`, `role:design-system`             |
...
| `feature-rooms`             | `capability:conversations`, `capability:discovery`, `capability:room-administration`, `capability:room-library`, `capability:workspace` | #311, #317, #318, #321, #322 | The Workspace application workflow currently contains conversation, room-library, administration, and discovery surfaces. |
...
| `feature-shell`                | `libs/feature/shell`                | role:application; capability:workspace, capability:runtime, capability:badge                                                                    |                  10 |
...
| `trinity`                      | `apps/trinity`                      | role:app; capability:composition                                                                                                                |                  21 |
