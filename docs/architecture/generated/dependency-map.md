...
This snapshot contains **64 Nx projects** and **228 dependencies**. No project cycles detected.
...
| `feature-rooms`                   | `libs/feature/rooms`                   | role:application; capability:workspace, capability:conversations, capability:room-library, capability:room-administration, capability:discovery |                  25 |
