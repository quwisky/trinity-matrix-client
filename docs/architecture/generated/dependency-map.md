...
This snapshot contains **64 Nx projects** and **224 dependencies**. No project cycles detected.
...
| -------------------- | -------: | ------------------------------------------------------------------------------------------------------ |
| `role:app`           |        3 | `role:app`, `role:application`, `role:capability`, `role:kernel`, `role:adapter`, `role:design-system` |
...
| Room Library service lines |     782 |          782 | #321          |
...
| `application-runtime`             | `libs/application/runtime`             | role:application; capability:runtime                                                                                                            |                  21 |
...
| `components-controls`             | `libs/components/controls`             | role:design-system; capability:design-system                                                                                                    |                  13 |
...
| `data-access-identity`            | `libs/data-access/identity`            | role:capability; capability:identity                                                                                                            |                   3 |
...
| `data-access-room-administration` | `libs/data-access/room-administration` | role:capability; capability:room-administration                                                                                                 |                   2 |
| `data-access-room-library`        | `libs/data-access/room-library`        | role:capability; capability:room-library                                                                                                        |                   3 |
...
| `feature-crypto`                  | `libs/feature/crypto`                  | role:capability; capability:trust                                                                                                               |                  10 |
| `feature-rooms`                   | `libs/feature/rooms`                   | role:application; capability:workspace, capability:conversations, capability:room-library, capability:room-administration, capability:discovery |                  24 |
| `feature-settings`                | `libs/feature/settings`                | role:application; capability:settings                                                                                                           |                  21 |
