...
This snapshot contains **79 Nx projects** and **271 dependencies**. No project cycles detected.
...
| `role:capability`    |       15 | `role:capability`, `role:kernel`, `role:adapter`, `role:design-system`                                 |
| `role:kernel`        |        1 | `role:kernel`                                                                                          |
| `role:adapter`       |        3 | `role:adapter`, `role:kernel`                                                                          |
| `role:design-system` |       53 | `role:design-system`, `role:kernel`, `role:adapter`                                                    |
...
| `components-input`             | `libs/components/input`             | role:design-system; capability:design-system                                                                             |                   8 |
