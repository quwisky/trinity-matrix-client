...
This snapshot contains **68 Nx projects** and **245 dependencies**. No project cycles detected.
...
| `data-access-notifications`       | `libs/data-access/notifications`       | role:capability; capability:notifications       |                   4 |
...
| `scripts`                         | `scripts`                              | unmanaged tooling/test                          |                   3 |
...
| `trinity-e2e-components`          | `e2e/components`                       | unmanaged tooling/test                          |                   6 |
| `trinity-e2e-support`             | `e2e/support`                          | unmanaged tooling/test                          |                   0 |
| `trinity-e2e-web`                 | `e2e/web`                              | unmanaged tooling/test                          |                   5 |
