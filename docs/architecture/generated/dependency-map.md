...
This snapshot contains **82 Nx projects** and **275 dependencies**. No project cycles detected.
...
| `role:application`   |        2 | `role:application`, `role:capability`, `role:kernel`, `role:adapter`, `role:design-system`             |
| `role:capability`    |       16 | `role:capability`, `role:kernel`, `role:adapter`, `role:design-system`                                 |
| `role:kernel`        |        2 | `role:kernel`                                                                                          |
...
| --------------------------- | --------------------------- | ------------- | ----------------------------------------------------------------------------- |
| `data-access-auth`          | `data-access-notifications` | #303, #315    | Legacy logout coordinates notification cleanup directly.                      |
...
| `feature-rooms`             | `data-access-accounts`      | #310          | The current room shell is the Workspace adapter for atomic Account switching. |
| `feature-rooms`             | `data-access-auth`          | #303, #310    | The current room shell still coordinates Account logout and navigation.       |
| `feature-rooms`             | `data-access-crypto`        | #318, #319    | Conversation surfaces currently read trust state directly.                    |
| `feature-rooms`             | `data-access-notifications` | #315-#317     | The room shell currently coordinates notification and badge behavior.         |
| `feature-rooms`             | `data-access-profile`       | #320          | Room surfaces currently consume identity state directly.                      |
...
| --------------------------- | --------------------------------------------------------------------------------------------------------------- | ---------------- | ----------------------------------------------------------------------------------------------------- |
| `data-access-notifications` | `capability:badge`, `capability:notifications`                                                                  | #316             | Notification delivery and badge aggregation have not yet been separated.                              |
| `data-access-rooms`         | `capability:discovery`, `capability:room-administration`, `capability:room-library`                             | #317, #318, #321 | Room relationships, governance, and discovery still share one data-access library.                    |
...
| `feature-rooms`             | `capability:conversations`, `capability:discovery`, `capability:room-administration`, `capability:room-library` | #304-#322        | The current room feature contains conversation, room-library, administration, and discovery surfaces. |
| `feature-shell`             | `capability:badge`, `capability:runtime`, `capability:workspace`                                                | #314, #316       | Workspace, application runtime, and badge coordination still share the shell.                         |
...
| `data-access-invites`          | `@trinity/data-access/invites`          | `./libs/data-access/invites/src/index.ts`          |
...
| `data-access-pinned`           | `@trinity/data-access/pinned`           | `./libs/data-access/pinned/src/index.ts`           |
...
| Message projection lines |    1738 |         1738 | #305-#309     |
...
| `data-access-auth`             | `libs/data-access/auth`             | role:capability; capability:accounts                                                                                     |                   6 |
...
| `data-access-matrix-client`    | `libs/data-access/matrix-client`    | role:adapter; capability:matrix-runtime                                                                                  |                   3 |
| `data-access-media`            | `libs/data-access/media`            | role:adapter; capability:media                                                                                           |                   2 |
| `data-access-notifications`    | `libs/data-access/notifications`    | role:capability; capability:notifications, capability:badge                                                              |                   5 |
| `data-access-pinned`           | `libs/data-access/pinned`           | role:capability; capability:conversations                                                                                |                   2 |
...
| `data-access-timeline`         | `libs/data-access/timeline`         | role:capability; capability:conversations                                                                                |                   4 |
...
| `feature-auth`                 | `libs/feature/auth`                 | role:capability; capability:accounts                                                                                     |                  13 |
| `feature-crypto`               | `libs/feature/crypto`               | role:capability; capability:trust                                                                                        |                  15 |
| `feature-rooms`                | `libs/feature/rooms`                | role:capability; capability:conversations, capability:room-library, capability:room-administration, capability:discovery |                  42 |
| `feature-settings`             | `libs/feature/settings`             | role:application; capability:settings                                                                                    |                  29 |
| `feature-shell`                | `libs/feature/shell`                | role:application; capability:workspace, capability:runtime, capability:badge                                             |                   9 |
...
| `platform-native`              | `libs/platform-native`              | role:adapter; capability:host                                                                                            |                   1 |
...
| `trinity`                      | `apps/trinity`                      | role:app; capability:composition                                                                                         |                  17 |
