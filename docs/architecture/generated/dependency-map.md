...
This snapshot contains **85 Nx projects** and **286 dependencies**. No project cycles detected.
...
| `role:application`   |        5 | `role:application`, `role:capability`, `role:kernel`, `role:adapter`, `role:design-system`             |
