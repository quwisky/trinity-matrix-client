...
This snapshot contains **81 Nx projects** and **272 dependencies**. No project cycles detected.
...
| `feature-rooms`                | `libs/feature/rooms`                | role:capability; capability:conversations, capability:room-library, capability:room-administration, capability:discovery |                  40 |
