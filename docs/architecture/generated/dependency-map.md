...
This snapshot contains **73 Nx projects** and **269 dependencies**. No project cycles detected.
...
| `application-runtime`             | `libs/application/runtime`             | role:application; capability:runtime            |                  23 |
...
| `components-controls`             | `libs/components/controls`             | role:design-system; capability:design-system    |                  14 |
