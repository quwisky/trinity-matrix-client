...
This snapshot contains **82 Nx projects** and **274 dependencies**. No project cycles detected.
...
| `feature-auth`                 | `libs/feature/auth`                 | role:capability; capability:accounts                                                                                     |                  14 |
...
| `trinity`                      | `apps/trinity`                      | role:app; capability:composition                                                                                         |                  18 |
