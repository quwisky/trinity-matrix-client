...
are the only places `matrix-js-sdk` is imported — twelve of the fifteen do, with
...
| `libs/data-access/search`              | `@trinity/data-access/search`              | `type:data-access`, `scope:matrix`     | Local quick-switcher ranking and in-room message search; feature surfaces compose its local results with Identity directory lookup                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         |
...
`search → room-library`, `identity → media`, `timeline → media`, and
