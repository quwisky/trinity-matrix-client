...
| Library                          | Alias                                | Tags                                   | Purpose                                                                                                                                                                                                                                             |
| -------------------------------- | ------------------------------------ | -------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `libs/data-access/accounts`      | `@trinity/data-access/accounts`      | `type:data-access`, `scope:matrix`     | Account Runtime: read-only lifecycle state and one cold restore command that prioritises the Active Account, bounds every saved Account, records terminal outcomes and timings, and isolates inactive failures behind a storage/Matrix adapter seam |
