...
The workspace holds one application and 80 libraries. Every shipped library carries its current
...
`application/` (1), `data-access/` (14), `feature/` (5), `util/` (2), `runtime/` (3) and `components/` (31) — the public
