...
| `libs/feature/settings` | `@trinity/feature/settings` | `type:feature`, `scope:matrix` | Exports only `settingsRoutes`; the settings shell and its fourteen sections are internal routing targets                                                                                          |
