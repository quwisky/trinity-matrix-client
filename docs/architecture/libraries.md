...
are the only places `matrix-js-sdk` is imported — twelve of the fourteen do, with
...
| `libs/data-access/rooms`         | `@trinity/data-access/rooms`         | `type:data-access`, `scope:matrix`     | The largest domain library: the room list, spaces, space children and per-space ordering, room settings, moderation, pin governance and aliases, the public-room directory, the account scope, the three mixed-account projections, and the unread aggregator                                                                                                                                                                                                                                                                                                                                            |
