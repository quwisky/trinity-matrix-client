...
| `libs/data-access/media`         | `@trinity/data-access/media`         | `type:data-access`, `scope:matrix`     | `MediaService` for encrypted attachments, `AvatarService`, and the bounded MSC2545 `ImagePackService` projection                                                                                                                              |
