...
| Library                       | Alias                             | Tags                                                                               | Purpose                                                                                                                                                                                                                                                                                       |
| ----------------------------- | --------------------------------- | ---------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `libs/application/appearance` | `@trinity/application/appearance` | `type:data-access`, `scope:matrix`, `role:application`, `capability:design-system` | Four Design System Appearance descriptors plus the application-level read model that composes them with Conversations' two code-presentation descriptors; persistence stays in Preference Runtime, per-axis state stays independent, and partial hydration produces one warning-ready outcome |
