...
| Library                | Alias                      | Tags                                                               | Purpose                                                                                                                                                                                                                                                                                                                                                      |
| ---------------------- | -------------------------- | ------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| `libs/platform-native` | `@trinity/platform-native` | `type:platform`, `scope:shared`, `role:adapter`, `capability:host` | Web, Capacitor, and Electron adapters selected at composition, plus legacy platform services still migrating behind the operation contracts: secure/session storage, preferences, geolocation, voice, host media, theme, external-browser dispatch, the Electron preload bridge, keyboard shortcuts, error handling, build information, and reset primitives |
