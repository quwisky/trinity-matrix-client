...
The workspace holds one application and 81 libraries. Every shipped library carries its current
...
`application/` (3), `data-access/` (14), `feature/` (5), `util/` (2), `runtime/` (3) and `components/` (31) — the public
...
| `libs/data-access/rooms`         | `@trinity/data-access/rooms`         | `type:data-access`, `scope:matrix`     | The remaining Room Administration and Discovery adapters: room settings, moderation, message/pin governance, aliases, room-link previews and the public-room directory. Its two-capability exception is removed by #318 and #321                                                                                                                                                                                                                                                                                                                                                                                                                                                           |
...
`search → room-library, rooms`, `rooms → room-library`, `timeline → media`, and
