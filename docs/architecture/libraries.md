...
| `libs/application/workspace`  | `@trinity/application/workspace`  | `type:data-access`, `scope:matrix`, `role:application`, `capability:workspace`     | Typed Room navigation and application-surface intents; the fixed semantic Back registry; and cold application ports whose Workspace/Router/platform/UI adapters are supplied only by the composition root                                                                                                                     |
