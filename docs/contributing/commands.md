...
`pnpm exec nx run trinity-e2e-components:production-renderer` creates a production `www/`, records
...
| `pnpm e2e:components` | Storybook, styling, scrollbar and production-renderer contracts |
