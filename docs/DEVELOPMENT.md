...
| Grouped families               | angular · nx · matrix-js-sdk (+ crypto WASM) · capacitor · spartan-ng · playwright · vitest · eslint · tailwind — each moves as a unit because a partial bump usually breaks the build — 'usually', not always: eslint 10 landed alone, since typescript-eslint 8.64 already accepted it |
