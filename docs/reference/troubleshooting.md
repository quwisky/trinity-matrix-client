...
Trust, Identity, Notification, Room Administration, native-push, Badge, Update, Preference and
Room-order health diagnostics contain only generated scope references, stable
