...
| `@ng-icons/lucide`                    | 34.0.0  | Icon set behind `<trn-icon>`; imported by `@trinity/helm/icon` and five generated kit libraries; `@ng-icons/core` moves with it |
...
| `@ctrl/ngx-emoji-mart`                | 9.3.0   | Emoji picker for the composer and reactions, reached only through `@trinity/helm/emoji-picker`                                  |
