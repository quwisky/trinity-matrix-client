...
This snapshot contains **78 Nx projects** and **287 dependencies**. No project cycles detected.
...
| `scripts`                         | `scripts`                              | unmanaged tooling/test                          |                   9 |
...
| `trinity-web-container`           | `container`                            | role:app; capability:composition                |                   1 |
