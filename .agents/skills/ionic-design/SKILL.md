...
```tsx
import { IonList, IonItem, IonLabel, IonNote, IonAvatar, IonIcon, IonItemSliding, IonItemOptions, IonItemOption } from '@ionic/react';
...
```tsx
import { IonInput, IonTextarea, IonSelect, IonSelectOption, IonToggle, IonCheckbox, IonRadioGroup, IonRadio, IonItem, IonLabel, IonButton } from '@ionic/react';
...
function MyForm() {
  return (
    <form>
      ...
      {/* Textarea */}
      <IonItem>
        <IonTextarea label="Bio" labelPlacement="floating" rows={4} placeholder="Tell us about yourself" />
      </IonItem>
...
```tsx
import { IonCard, IonCardHeader, IonCardTitle, IonCardSubtitle, IonCardContent, IonImg, IonButton } from '@ionic/react';
...
function Cards() {
  return (
    <IonCard>
      ...
      <IonCardContent>Card content goes here. This is a standard card with an image, title, subtitle, and content.</IonCardContent>
...
function ModalExample() {
  ...
  return (
    <>
      ...
      {/* Bottom sheet */}
      <IonModal ref={modal} trigger="open-sheet" initialBreakpoint={0.5} breakpoints={[0, 0.25, 0.5, 0.75, 1]}>
        <IonContent>
...
function BackButton() {
  return <IonIcon icon={isPlatform('ios') ? chevronBack : arrowBack} />;
}
```
