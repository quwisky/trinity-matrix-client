...
description: |
  ...
  DO NOT USE FOR: WCAG compliance auditing (use playwright-best-practices),
  Tailwind-specific utility classes (use angular-developer),
  component library APIs (use spartan)
