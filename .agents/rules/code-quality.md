...
| Services / capability projections | 200–400 | 500+        |
...
- **Large services**: split along workflow seams (e.g. Account lifecycle commands vs Matrix session adapters), not arbitrary line counts.
