...
- **Production Web, PWA and Electron now prove the shipped Appearance system end to end.** The
  ...
  motion and the Electron custom protocol. Forced-colour keyboard focus now uses the system
  highlight colour so it remains visible when shadow-based rings are suppressed.
