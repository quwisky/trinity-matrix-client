...
- **Links from clients that mislabeled Markdown as Matrix HTML are clickable again.** A
  ...
  The latest readable version now also stays on screen while the Matrix SDK temporarily
  aggregates such a malformed edit, before history repair has had a chance to discard it.
